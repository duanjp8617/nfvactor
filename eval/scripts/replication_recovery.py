...
def main():
    ...
    time.sleep(5)
    print "Start replication recovery demo."
    env_setup.start_traffic_generator("fg1", info.r1_rt1)

    time.sleep(5)
    print "Start recovery."
    rpc.AddOutputMac(info.r1_rt1, info.r1_rt3)
    rpc.Recover(info.r1_rt3, info.r1_rt2)

    time.sleep(5)
    print "Read recovery stats from runtime 3:"
    print stats.get_runtime_replication_stat(stats.read_runtime_log(info.r1_env, info.r1_rt3))
